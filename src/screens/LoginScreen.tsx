...
export default function LoginScreen({ navigation }: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <CustomButton title="Login" onPress={handleLogin} disabled={loading} loading={loading} />
      <CustomButton title="Go to Signup" onPress={() => navigation.navigate('Signup')} backgroundColor="#6b7280" />
      <View style={{ height: 12 }} />
      <Text style={styles.hint}>Tip: pick role when you signup or ask admin to set role.</Text>
